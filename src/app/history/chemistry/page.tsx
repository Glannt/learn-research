...
export default function ChemistryHistoryPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-3xl font-semibold">{t("historyChemistryTitle")}</h1>
        <p className="mt-2 text-muted-foreground">{t("historyChemistryDesc")}</p>
      </div>
      <ScienceTimeline topics={scienceHistoryTopics} subject="chemistry" />
    </div>
  );
}
